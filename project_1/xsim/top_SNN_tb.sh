...
#
# Generated by Vivado on Wed Jun 28 01:25:34 +0200 2023
# SW Build 3671981 on Fri Oct 14 05:00:03 MDT 2022
#
# Tool Version Limit: 2022.10 
#
# usage: top_SNN_tb.sh [-help]
# usage: top_SNN_tb.sh [-lib_map_path]
# usage: top_SNN_tb.sh [-noclean_files]
# usage: top_SNN_tb.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "top_SNN_tb.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L secureip -L xpm --snapshot top_SNN_tb xil_defaultlib.top_SNN_tb -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  top_SNN_tb -key {Behavioral:sim_1:Functional:top_SNN_tb} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./top_SNN_tb.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb top_SNN_tb.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./top_SNN_tb.sh -help\" for more information)\n"
    exit 1
  fi
