...
#
# Generated by export_simulation on Wed Jun 28 01:25:34 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './top_SNN_tb.sh' script.

./top_SNN_tb.sh -reset_run
...
./top_SNN_tb.sh -noclean_files

For more information on the script, please type './top_SNN_tb.sh -help'.
